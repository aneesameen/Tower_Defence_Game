...
pygame.display.set_caption("Tower Defence Game By Anees !")
...
# Enemy
left_enemy = [pygame.image.load(os.path.join("Enemy", "LE1.png")),
        pygame.image.load(os.path.join("Enemy", "LE2.png")),
        pygame.image.load(os.path.join("Enemy", "LE3.png")),
        pygame.image.load(os.path.join("Enemy", "LE4.png")),
        pygame.image.load(os.path.join("Enemy", "LE5.png")),
        pygame.image.load(os.path.join("Enemy", "LE6.png")),
        pygame.image.load(os.path.join("Enemy", "LE7.png")),
        pygame.image.load(os.path.join("Enemy", "LE8.png")),
        pygame.image.load(os.path.join("Enemy", "LE9.png"))
        ]
right_enemy = [pygame.image.load(os.path.join("Enemy", "RE1.png")),
        pygame.image.load(os.path.join("Enemy", "RE2.png")),
        pygame.image.load(os.path.join("Enemy", "RE3.png")),
        pygame.image.load(os.path.join("Enemy", "RE4.png")),
        pygame.image.load(os.path.join("Enemy", "RE5.png")),
        pygame.image.load(os.path.join("Enemy", "RE6.png")),
        pygame.image.load(os.path.join("Enemy", "RE7.png")),
        pygame.image.load(os.path.join("Enemy", "RE8.png")),
        pygame.image.load(os.path.join("Enemy", "RE9.png"))
        ]
# Bullet
bullet_img = pygame.transform.scale(pygame.image.load(os.path.join("Bullet", "bullet.png")), (10, 10))
# Background
background = pygame.transform.scale(pygame.image.load(os.path.join("pics/Background.png")), (win_width, win_height))
# Tower
tower = pygame.transform.scale(pygame.image.load(os.path.join("pics/Tower.png")), (200,200))
# Music And Sounds
music = pygame.mixer.music.load("Music/song.wav")
pop_sound = pygame.mixer.Sound("Music/pop.wav")
...
class Enemy:
    ...
    def draw(self, win):
        ...
        if self.health >= 0:
            pygame.draw.rect(win, (0, 255, 0), (self.x + 15, self.y, self.health, 10))
        self.step()
        win.blit(left_enemy[self.stepIndex // 4], (self.x, self.y))
        self.stepIndex += 1
...
def draw_game():
    ...
    for enemy in enemies:
        enemy.draw(win)
    # Draw Tower
    win.blit(tower, (-95, 165))
    # Player Health
    if player.alive == False:
        win.fill((0, 0, 0))
        font = pygame.font.Font('freesansbold.ttf', 32)
        text = font.render('You Lost! Press R to restart', True, (255, 255, 255))
